 ...
 */
public class QuarkusPlatformMixin implements QuarkusPlatformMixinSpec {
    ...
    public QuarkusPlatformBom resolve(String camelVersion, Function<MavenGav, MavenArtifact> mavenDownloader) {
        if (quarkusVersion != null) {
            ...
            return new QuarkusPlatformBom(quarkusGroupId, quarkusVersion, cv);
        } else {
            return QuarkusHelper.findQuarkusPlatformBom(camelVersion, mavenDownloader);
        }
    }
